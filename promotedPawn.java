...
public class promotedPawn extends GamePiece implements MouseListener {
    private int posX;
    private int posY;
    ...
    public promotedPawn(boolean isOpponent, int x, int y, GameBoard b)
    {
    	 super(isOpponent);
         posX = x;
         posY = y;
    ...
    public promotedPawn(int x, int y, GameBoard b)
    {
    	this(false, x, y, b);
    }

    public promotedPawn(boolean isOpponent)
    {
        super(isOpponent);
