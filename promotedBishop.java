...
public class promotedBishop extends GamePiece implements MouseListener {
    private int posX;
    private int posY;
    ...
    public promotedBishop(boolean isOpponent, int x, int y, GameBoard b)
    {
        super(isOpponent);
        posX = x;
        posY = y;
    ...
    public promotedBishop(int x, int y, GameBoard b)
    {
    	this(false, x, y, b);
    }

    public promotedBishop(boolean isOpponent)
    {
        super(isOpponent);
