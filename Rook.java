...
public class Rook extends GamePiece implements MouseListener {
    private int posX;
    private int posY;
    ...
    public Rook(boolean isOpponent, int x, int y, GameBoard b)
    {
        super(isOpponent);
        posX = x;
        posY = y;
    ...
    public Rook(int x, int y, GameBoard b)
    {
    	  this(false, x, y, b);
    }

    public Rook(boolean isOpponent)
    {
        super(isOpponent);
