...
public class promotedLance extends GamePiece implements MouseListener {
    private int posX;
    private int posY;
    ...
    public promotedLance(boolean isOpponent, int x, int y, GameBoard b)
    {
    	 super(isOpponent);
         posX = x;
         posY = y;
    ...
    public promotedLance(int x, int y, GameBoard b)
    {
    	this(false, x, y, b);
    }

    public promotedLance(boolean isOpponent)
    {
        super(isOpponent);
