...
public class promotedKnight extends GamePiece implements MouseListener {
    private int posX;
    private int posY;
    ...
    public promotedKnight(boolean isOpponent, int x, int y, GameBoard b)
    {
    	 super(isOpponent);
         posX = x;
         posY = y;
    ...
    public promotedKnight(int x, int y, GameBoard b)
    {
    	this(false, x, y, b);
    }

    public promotedKnight(boolean isOpponent)
    {
        super(isOpponent);
