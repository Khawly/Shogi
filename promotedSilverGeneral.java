...
public class promotedSilverGeneral extends GamePiece implements MouseListener {
    private int posX;
    private int posY;
    ...
    public promotedSilverGeneral(boolean isOpponent, int x, int y, GameBoard b)
    {
    	 super(isOpponent);
         posX = x;
         posY = y;
    ...
    public promotedSilverGeneral(int x, int y, GameBoard b)
    {
    	this(false, x, y, b);
    }

    public promotedSilverGeneral(boolean isOpponent)
    {
        super(isOpponent);
